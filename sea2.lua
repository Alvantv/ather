...
local locations = {
    ["Washup Shore"] = Vector3.new(-49, 129, -48),
    ["Botanical Bay"] = Vector3.new(1663, 129, 148),
    ["Emoji Cove"] = Vector3.new(1104, 129, -3073),
    ["Skeleton Shore"] = Vector3.new(-2225, 127, -262),
    ["Carnival Key"] = Vector3.new(-1455, 135, 1906),
    ["Animal Isle"] = Vector3.new(2693, 129, 2557),
    ["Island Of Enchantment"] = Vector3.new(3397, 155, -3129),
    ["Coral Bay"] = Vector3.new(-1467, 126, 806),
    ["Steampunk Island"] = Vector3.new(121, 131, 2456),
    ["UFO Point"] = Vector3.new(-2657, 133, 2736),
    ["Pet Isle"] = Vector3.new(-2619, 126, 1314),
    ["Ice Mountain Shore"] = Vector3.new(2377, 234, -1413),
    ["Retro Reef"] = Vector3.new(-804, 125, -2849),
    ["Banana Bay"] = Vector3.new(3591, 127, 949),
    ["Chomp Cove"] = Vector3.new(1443, 131, 1746),
    ["Mecha Isle"] = Vector3.new(4729, 129, -898),
    ["Swampy Cove"] = Vector3.new(-2626, 133, -1880),
    ["Sunken Island"] = Vector3.new(3910, 130, 2150),
    ["Prison Bay"] = Vector3.new(1163, 129, 2863)
}
...
local rotations = {
    ["Washup Shore"] = math.rad(0),
    ["Botanical Bay"] = 0,
    ["Emoji Cove"] = math.rad(180),
    ["Skeleton Shore"] = -20,
    ["Carnival Key"] = 20,
    ["Animal Isle"] = 0,
    ["Island Of Enchantment"] = 0,
    ["Coral Bay"] = 40,
    ["Steampunk Island"] = 5,
    ["UFO Point"] = 0,
    ["Pet Isle"] = 0, 
    ["Ice Mountain Shore"] = 0,
    ["Retro Reef"] = 20,
    ["Banana Bay"] = math.rad(160),
    ["Chomp Cove"] = math.rad(160),
    ["Mecha Isle"] = math.rad(60),
    ["Swampy Cove"] = math.rad(-70),
    ["Sunken Island"] = 0,
    ["Prison Bay"] = 0
}
...
local Window = WindUI:CreateWindow({
    Title = "Aether Hub | Go Fishing Sea 2 🎃",
    Icon = "rocket",
...
Farm:Dropdown({
    ...
    Values = {"Washup Shore", "Botanical Bay","Emoji Cove","Skeleton Shore","Carnival Key","Animal Isle","Island Of Enchantment","Coral Bay","Steampunk Island","UFO Point","Pet Isle","Ice Mountain Shore","Retro Reef","Banana Bay","Chomp Cove","Mecha Isle","Swampy Cove","Sunken Island","Prison Bay"},
    Default = "Washup Shore",
    Callback = function(v)
        selectedLocation = v
